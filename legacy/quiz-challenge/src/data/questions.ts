...
export const questions: Question[] = [
  ...
  },
  {
    ...
    category: "한국사",
    difficulty: "보통",
    question: "조선시대 기본 법전인 '경국대전'을 최종 완성·반포한 왕은?",
    options: ["세조", "세종대왕", "태종", "성종"],
    answer: 3,
    explanation: "경국대전은 세조 때 편찬이 시작되어 성종 때인 1485년에 최종 완성·반포된 조선의 기본 법전입니다."
  },
  {
    id: 44,
    category: "한국사",
    difficulty: "어려움",
    question: "조선 후기 '삼정의 문란'에서 말하는 삼정(三政)에 포함되지 않는 것은?",
    options: ["전정(田政)", "군정(軍政)", "환곡(還穀)", "공납(貢納)"],
    answer: 3,
    explanation: "삼정은 전정(토지세), 군정(군포), 환곡(곡식 대여)을 말합니다. 공납은 지방 특산물을 바치는 별도의 제도로, 대동법에 의해 개혁되었습니다."
  },

  // ========================================
  // 과학 (11문제: 쉬움 3, 보통 4, 어려움 4)
  // ========================================
  {
    id: 11,
    category: "과학",
  ...
  },
  {
    ...
    category: "과학",
    difficulty: "어려움",
    question: "1몰(mol)에 포함된 입자 수를 나타내는 아보가드로 수에 가장 가까운 값은?",
    options: ["6.02 × 10²⁰", "6.02 × 10²³", "6.02 × 10²⁶", "6.02 × 10¹⁸"],
    answer: 1,
    explanation: "아보가드로 수는 약 6.022 × 10²³으로, 2019년 SI 재정의에 따라 정확히 6.02214076 × 10²³으로 확정되었습니다."
  },

  // ========================================
  // 지리 (11문제: 쉬움 4, 보통 4, 어려움 3)
  // ========================================
  {
    id: 21,
    category: "지리",
  ...
  },
  {
    ...
    options: ["베이징", "상하이", "광저우", "홍콩"],
    answer: 0,
    explanation: "베이징(북경)은 중국의 수도로, 자금성과 만리장성 등 역사적 유적이 많은 도시입니다."
  },
