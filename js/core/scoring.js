 ...
 */
function tallyByCategory(questions, answers) {
  const tally = new Map();
 ...
 */
function collectReview(questions, answers) {
  return answers
 ...
 *   mode: 'category'|'all', categoryId?: string|null
 * }} params questions와 answers는 같은 순서로 짝지어진다
 */
export function summarizeRound({ questions, answers, mode, categoryId = null }) {
